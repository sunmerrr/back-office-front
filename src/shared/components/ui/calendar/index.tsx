...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-3 max-h-[363px]", className)}
      classNames={{
        root: `${defaultClassNames.root} bg-white shadow-lg p-5`,
        chevron: `${defaultClassNames.chevron} fill-amber-500`,
        months: "relative",
        month: "space-y-4",
        month_caption: "w-full flex justify-center pt-1 items-center",
        caption_label: "text-sm font-medium",
        nav: "absolute w-full space-x-1 flex items-center justify-between",
        nav_button: cn(
